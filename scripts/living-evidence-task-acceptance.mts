  ...
  try {
    ...
    try {
      ...
      if (
        ...
        "0001_living_evidence,0002_research_frontier,0003_community_forum_synthetic_lab,0004_community_forum_composer_frontier_queues,0005_community_forum_hostile_lifecycle_research"
      ) {
    ...
    checks.push("immutable_five_migration_chain_applied");
