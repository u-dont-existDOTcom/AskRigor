  ...
  try {
    ...
    try {
      ...
      if (
        ...
        "0001_living_evidence,0002_research_frontier,0003_community_forum_synthetic_lab,0004_community_forum_composer_frontier_queues"
      ) {
    ...
    checks.push("immutable_four_migration_chain_applied");
