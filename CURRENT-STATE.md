...
Sixty primary first-pass responses are now frozen in the private capture
ledger: 48 recorded automatic Web-search behavior and 12 did not. This is only a
...
Sequences 25 through 60 then completed and were frozen after bounded cooldowns;
