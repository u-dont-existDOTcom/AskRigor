...
Thirty-two primary first-pass responses are now frozen in the private capture
ledger: 26 recorded automatic Web-search behavior and 6 did not. This is only a
...
Sequences 25 through 32 then completed and were frozen after bounded cooldowns;
