...
Sixty-four primary first-pass responses are now frozen in the private capture
ledger: 51 recorded automatic Web-search behavior and 13 did not. This is only a
...
Sequences 25 through 64 then completed and were frozen after bounded cooldowns;
