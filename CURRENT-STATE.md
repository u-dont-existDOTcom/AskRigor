...
Eighty-four primary first-pass responses are now frozen in the private capture
ledger: 64 recorded automatic Web-search behavior and 20 did not. This is only a
...
Sequences 25 through 84 then completed and were frozen after bounded cooldowns;
