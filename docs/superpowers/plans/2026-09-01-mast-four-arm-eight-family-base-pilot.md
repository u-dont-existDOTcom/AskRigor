...
8. [ ] Capture the remaining 60 primary first-pass GPT-5.6 Sol Extra High
   ...
   frozen as valid. Sequences 25 through 36 are also frozen; resume at sequence
   37 after the provider cooldown.
