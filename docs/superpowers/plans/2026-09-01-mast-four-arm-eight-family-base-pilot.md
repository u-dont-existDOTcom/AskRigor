...
8. [ ] Capture the remaining 20 primary first-pass GPT-5.6 Sol Extra High
   ...
   frozen as valid. Sequences 25 through 76 are also frozen; resume at sequence
   77 after the provider cooldown.
