...
8. [ ] Capture the remaining 24 primary first-pass GPT-5.6 Sol Extra High
   ...
   frozen as valid. Sequences 25 through 72 are also frozen; resume at sequence
   73 after the provider cooldown.
