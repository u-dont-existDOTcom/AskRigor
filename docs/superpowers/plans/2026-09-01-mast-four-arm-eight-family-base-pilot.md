...
8. [ ] Capture the remaining 12 primary first-pass GPT-5.6 Sol Extra High
   ...
   frozen as valid. Sequences 25 through 84 are also frozen; resume at sequence
   85 after the provider cooldown.
