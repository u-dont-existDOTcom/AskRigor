...
8. [ ] Capture the remaining 56 primary first-pass GPT-5.6 Sol Extra High
   ...
   frozen as valid. Sequences 25 through 40 are also frozen; resume at sequence
   41 after the provider cooldown.
