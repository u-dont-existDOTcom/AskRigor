...
8. [ ] Capture the remaining 52 primary first-pass GPT-5.6 Sol Extra High
   ...
   frozen as valid. Sequences 25 through 44 are also frozen; resume at sequence
   45 after the provider cooldown.
