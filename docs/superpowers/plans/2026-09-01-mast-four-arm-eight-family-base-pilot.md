...
8. [ ] Capture the remaining 16 primary first-pass GPT-5.6 Sol Extra High
   ...
   frozen as valid. Sequences 25 through 80 are also frozen; resume at sequence
   81 after the provider cooldown.
