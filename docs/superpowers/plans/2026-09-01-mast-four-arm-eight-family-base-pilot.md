...
8. [ ] Capture the remaining 68 primary first-pass GPT-5.6 Sol Extra High
   ...
   frozen as valid. Sequences 25 through 28 are also frozen; resume at sequence
   29 after the provider cooldown.
