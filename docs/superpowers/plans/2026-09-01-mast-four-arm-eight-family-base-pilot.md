...
8. [ ] Capture the remaining 28 primary first-pass GPT-5.6 Sol Extra High
   ...
   frozen as valid. Sequences 25 through 68 are also frozen; resume at sequence
   69 after the provider cooldown.
