...
8. [ ] Capture the remaining 64 primary first-pass GPT-5.6 Sol Extra High
   ...
   frozen as valid. Sequences 25 through 32 are also frozen; resume at sequence
   33 after the provider cooldown.
