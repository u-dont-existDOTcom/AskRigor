...
8. [ ] Capture the remaining 48 primary first-pass GPT-5.6 Sol Extra High
   ...
   frozen as valid. Sequences 25 through 48 are also frozen; resume at sequence
   49 after the provider cooldown.
