...
- [x] Open a pull request, wait for required checks, and merge the exact green head.
- [x] Verify merged `main` reports Universal 20.5.13 and its new digest.
...
- Exact reviewed PR head: `b071706535fd879f910223d9cf0a0cfb7c2fbd80`; deterministic verification run `32001557454` and repository workflow-policy run `32001557443` both succeeded.
- Pull request `#25` merged by squash as `38d7b580f4876c68dc6770c3edcf4149d41dcb96` on 2026-08-17.
- Merged-main readback confirms `protocols/Universal_Instructions.xml` is Universal `20.5.13` / `2026-08-17`, with SHA-256 `3bef54307403df2cbd459377bc308747db47310aefe68cac3b7b2b75c87f92c4`; HRP remains unchanged.
