...
**Checkpoint:** 2026-09-03 02:37 UTC
...
**Status:** `V2_PRIMARY_CAPTURE_ACTIVE / 50_VALID`
...
Continue primary capture at ordinal 51 after the longer provider cooldown.
...
Primary capture is valid through ordinal 50 of 192. Both original ordinal 30 attempts
...
Ordinal 51 is now the exact next action after the longer cooldown.
...
`BLINDED_EVALUATOR_V2_PRIMARY_CAPTURE_ACTIVE_50_VALID`.
