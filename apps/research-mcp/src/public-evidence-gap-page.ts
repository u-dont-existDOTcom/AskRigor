  ...
  <main>
    ...
    <section id="contribute" class="workspace" aria-labelledby="form-title">
      ...
      <form id="source-form" class="step" data-step="1">
        ...
        <p class="privacy-note"><strong>Private by default.</strong> Your raw submission is not put on a public case page. You will receive a recovery key used to inspect or withdraw it.</p>
      ...
      <form id="consent-form" class="step" data-step="4" hidden>
        ...
        <div class="consent-list">
          <label><input type="checkbox" name="privateGptAnalysis" required> I allow AskRigor/GPT to privately analyze this case as an unverified evidence lead.</label>
